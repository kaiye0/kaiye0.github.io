...
sr.reveal('.home__img, .about__subtitle, .about__description, .skills__img',{delay: 400}); 
sr.reveal('.home__social-icon',{ interval: 200}); 
sr.reveal('.skills__data, .qualification__data, .portfolio__content, .contact__information',{interval: 200}); 